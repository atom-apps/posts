...
func newChapter(db *gorm.DB, opts ...gen.DOOption) chapter {
	...
	_chapter.ID = field.NewUint64(tableName, "id")
	_chapter.CreatedAt = field.NewTime(tableName, "created_at")
	_chapter.UpdatedAt = field.NewTime(tableName, "updated_at")
	_chapter.DeletedAt = field.NewField(tableName, "deleted_at")
	_chapter.TenantID = field.NewUint64(tableName, "tenant_id")
	_chapter.UserID = field.NewUint64(tableName, "user_id")
	_chapter.BookID = field.NewUint64(tableName, "book_id")
	_chapter.Title = field.NewString(tableName, "title")
	_chapter.Description = field.NewString(tableName, "description")
	_chapter.Content = field.NewString(tableName, "content")
...
func (c *chapter) updateTableName(table string) *chapter {
	...
	c.TenantID = field.NewUint64(table, "tenant_id")
	c.UserID = field.NewUint64(table, "user_id")
	c.BookID = field.NewUint64(table, "book_id")
