...
func newArticleTag(db *gorm.DB, opts ...gen.DOOption) articleTag {
	...
	_articleTag.articleTagDo.UseModel(&models.ArticleTag{})

	tableName := _articleTag.articleTagDo.TableName()
	_articleTag.ALL = field.NewAsterisk(tableName)
	_articleTag.ID = field.NewUint64(tableName, "id")
	_articleTag.CreatedAt = field.NewTime(tableName, "created_at")
	_articleTag.ArticleID = field.NewUint64(tableName, "article_id")
	_articleTag.TagID = field.NewUint64(tableName, "tag_id")
...
type IArticleTagDo interface {
	...
	Create(values ...*models.ArticleTag) error
	CreateInBatches(values []*models.ArticleTag, batchSize int) error
	Save(values ...*models.ArticleTag) error
	First() (*models.ArticleTag, error)
	Take() (*models.ArticleTag, error)
	Last() (*models.ArticleTag, error)
	Find() ([]*models.ArticleTag, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.ArticleTag, err error)
	FindInBatches(result *[]*models.ArticleTag, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*models.ArticleTag) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*models.ArticleTag, error)
	FirstOrCreate() (*models.ArticleTag, error)
	FindByPage(offset int, limit int) (result []*models.ArticleTag, count int64, err error)
...
func (a articleTagDo) Create(values ...*models.ArticleTag) error {
	if len(values) == 0 {
		return nil
	}
...
func (a articleTagDo) CreateInBatches(values []*models.ArticleTag, batchSize int) error {
	return a.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (a articleTagDo) Save(values ...*models.ArticleTag) error {
	if len(values) == 0 {
		return nil
	}
...
func (a articleTagDo) First() (*models.ArticleTag, error) {
	if result, err := a.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*models.ArticleTag), nil
	}
}

func (a articleTagDo) Take() (*models.ArticleTag, error) {
...
func (a articleTagDo) Last() (*models.ArticleTag, error) {
...
func (a articleTagDo) Find() ([]*models.ArticleTag, error) {
	result, err := a.DO.Find()
	return result.([]*models.ArticleTag), err
}

func (a articleTagDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*models.ArticleTag, err error) {
	buf := make([]*models.ArticleTag, 0, batchSize)
...
func (a articleTagDo) FindInBatches(result *[]*models.ArticleTag, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (a articleTagDo) FirstOrInit() (*models.ArticleTag, error) {
...
func (a articleTagDo) FirstOrCreate() (*models.ArticleTag, error) {
...
func (a articleTagDo) FindByPage(offset int, limit int) (result []*models.ArticleTag, count int64, err error) {
...
func (a articleTagDo) Delete(models ...*models.ArticleTag) (result gen.ResultInfo, err error) {
